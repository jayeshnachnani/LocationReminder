...
import com.udacity.project4.databinding.ActivityGeoFenceMainBinding
...
class GeoFenceMainActivity : AppCompatActivity() {

    private lateinit var binding: ActivityGeoFenceMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_geo_fence_main)
 ...
 */
    ...
    private fun checkDeviceLocationSettingsAndStartGeofence(resolve:Boolean = true) {
        ...
        locationSettingsResponseTask.addOnFailureListener { exception ->
            if (exception is ResolvableApiException && resolve){
                try {
                    exception.startResolutionForResult(this@GeoFenceMainActivity,
            ...
            addOnCompleteListener {
                geofencingClient.addGeofences(geofencingRequest, geofencePendingIntent)?.run {
                    addOnSuccessListener {
                        Toast.makeText(this@GeoFenceMainActivity, R.string.geofences_added,
                            Toast.LENGTH_SHORT)
                            .show()
                    ...
                    addOnFailureListener {
                        Toast.makeText(this@GeoFenceMainActivity, R.string.geofences_not_added,
    ...
    companion object {
        internal const val ACTION_GEOFENCE_EVENT =
            "GeoFenceMainActivity.action.ACTION_GEOFENCE_EVENT"
    }
}
